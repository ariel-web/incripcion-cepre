    ...
    <div class="sidebar-wrapper sidebar-theme">
        <nav ref="menu" id="sidebar">
            ...
            <perfect-scrollbar class="list-unstyled menu-categories" tag="ul" :options="{ wheelSpeed: 0.5, swipeEasing: !0, minScrollbarLength: 40, maxScrollbarLength: 300, suppressScrollX: true }">
                ...
                <li class="menu">
                    <a href="#postulante" v-b-toggle class="dropdown-toggle" @click.prevent>
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                            <span>{{ $t('Postulante') }}</span>
                        </div>
                        <div>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <b-collapse id="postulante" accordion="menu">
                        <ul class="collapse submenu list-unstyled show">
                            <router-link tag="li" to="/Postulante" @click.native="toggleMobileMenu">
                                <a>{{ $t('Inscripciones') }}</a>
                            </router-link>
                            <!-- <router-link tag="li" to="/index2" @click.native="toggleMobileMenu">
                                <a>{{ $t('analytics') }}</a>
                ...
                <li class="menu">
                    <a href="#fotos" v-b-toggle class="dropdown-toggle" @click.prevent>
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-camera"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"></path><circle cx="12" cy="13" r="4"></circle></svg>
                            <span>{{ $t('Toma de fotos') }}</span>
                        </div>
                        <div>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <b-collapse id="fotos" accordion="menu">
                        <ul class="collapse submenu list-unstyled show">
                            <router-link tag="li" to="/Fotos" @click.native="toggleMobileMenu">
                                <a>{{ $t('Tomar Fotos') }}</a>
                            </router-link>
                        </ul>
                    </b-collapse>
                ...
                <li class="menu">
                    <a href="#impresiones" v-b-toggle class="dropdown-toggle" @click.prevent>
                        <div class="">
                    ...
                    <b-collapse id="impresiones" accordion="menu">
                        <ul class="collapse submenu list-unstyled show">
                            <router-link tag="li" to="/Impresiones" @click.native="toggleMobileMenu">
                                <a>{{ $t('Imp. constancia') }}</a>
                            </router-link>
                        </ul>
                    </b-collapse>
                </li>
                ...
                <li class="menu">
                    ...
                    <a href="#verificar" v-b-toggle class="dropdown-toggle" to="/Verificar" @click.native="toggleMobileMenu">
                        <div class="">
                            <router-link tag="li" to="/verificar" @click.native="toggleMobileMenu">
