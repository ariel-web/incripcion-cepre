...
const routes = [
...

    {
        path: '/Postulante',
        name: 'Inscripciones',
        component: () => import(/* webpackChunkName: "components-tabs" */ '../views/Postulante/Inscripciones.vue')
    },

    {
        path: '/Impresiones',
        name: 'Impresiones',
        component: () => import(/* webpackChunkName: "components-tabs" */ '../views/Postulante/Impriesiones/index.vue')
    },

    {
        path: '/Fotos',
        name: 'Fotos',
        component: () => import(/* webpackChunkName: "components-tabs" */ '../views/Postulante/Tomadefotos/index.vue')
    },
    ...
    //auth
    {
        path: '/login',
        name: 'login-sis',
        component: () => import(/* webpackChunkName: "pages-sample" */'../Login/login.vue'),
        meta: { layout: 'auth' }
    },
    {
