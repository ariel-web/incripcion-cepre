            ...
            <header class="header navbar navbar-expand-sm">
                <ul class="navbar-item theme-brand flex-row text-center">
                    <li class="nav-item theme-logo">
                        <router-link to="/">
                            <img src="@/assets/images/logo_unap.png" class="navbar-logo" alt="logo" />
                        </router-link>
                    </li>
                    <li class="nav-item theme-text">
                        <router-link to="/" style="font-size: 1rem;" class="nav-link">Una Puno</router-link>
                    </li>
                </ul>
                ...
                <div class="navbar-item flex-row ml-md-auto">
                    ...
                    <div style="margin-left: 7px;">
                        <div style="margin-top: 0px; text-align: right;">
                            Ariel Luque
                            <div style="margin-top: -10px;"><span style="font-size: .6rem;">Administrador</span></div>
                        </div>
                    </div>
