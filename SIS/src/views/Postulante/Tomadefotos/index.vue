...
<div class="p-2">
    <div class="card p-" >
            ...
            <b-tbody>
                <b-tr v-for="(row,index) in datos" :key="index">
                    ...
                    <b-td class="text-center">
                        <b-button variant="outline-primary" dense pill class="mt-0 mb-0" @click="$bvModal.show('fotoModal')">Tomar foto</b-button>
                    </b-td>
                </b-tr>
            </b-tbody>
        </b-table-simple>
        ...
        <b-modal id="fotoModal" title="Toma de imágenes" size="lg" >

            <div class="card" style="width: 760px; height: 450px;">
                <div style="display: flex;">
                    <div style="width: 50%; height: 450px; display: flex; justify-content: center; align-items: center;">
                        <div>
            ...
            <template #modal-footer>
                <label>Dni:</label>
                <b-input type="text" v-model="dni">  </b-input>
                <b-button variant="danger" @click="BorraCaptura"><i class="flaticon-cancel-12"></i>Borrar</b-button>
                <b-button variant="default" data-dismiss="modal" @click="$bvModal.hide('fotoModal')"><i class="flaticon-cancel-12"></i>Cancelar</b-button>
                <b-button variant="dark" @click="guardarFoto">Guardar</b-button>
            </template>
        </b-modal>
    </div>
</div>
...
export default {
    ...
    methods:{
        async getInscritos() {
            await axios.get("/get-ingresantes/"+this.search)
            .then(res=>{
        ...
        async guardarFoto() {
            await axios.post('guardarfoto', this.items[0].file, {headers : {'content-type': 'multipart/form-data'}})
        },
